...
PATH = "./deep_learning/torch_mnist/"
...
plt.title("loss")
plt.savefig(os.path.join(PATH, "imgs", "loss_image.png"))
plt.clf()
...
plt.title("accuracy")
plt.savefig(os.path.join(PATH, "imgs", "accuracy_image.png"))
print(os.path.join(PATH, "imgs", "accuracy_image.png"))
plt.show()
